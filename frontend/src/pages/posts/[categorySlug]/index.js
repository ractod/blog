...
const CategoryPage = ({ postsData, categoriesData }) => {
    return (
        <>
            <Head>
...
export const getServerSideProps = async context => {
    try {
        ...
        const response = await axios.all([
            axios.get(`/posts?categorySlug=${params.categorySlug}&${queryString.stringify(context.query)}`, {headers: { Cookie: context.req.headers.cookie || '' }}),
